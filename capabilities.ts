...
export const BOT_COMMANDS: BotCommandDescription[] = [
    ...
    {
        command: "watch",
        description: "Меню наблюдений за Telegram-чатами",
        scope: "owner",
        usage: "/watch",
        showInTelegramMenu: true,
    },
    {
        command: "watch_list",
        description: "Список промпт-наблюдений за чатами",
        scope: "owner",
        usage: "/watch_list",
    },
    {
        command: "watch_add",
        description: "Запустить мастер добавления наблюдения за чатом",
        scope: "owner",
        usage: "/watch_add",
        examples: ["/watch_add"],
    },
    {
        command: "watch_pause",
        description: "Поставить наблюдение на паузу",
        scope: "owner",
        usage: "/watch_pause <id>",
    },
    {
        command: "watch_resume",
        description: "Возобновить наблюдение",
        scope: "owner",
        usage: "/watch_resume <id>",
    },
    {
        command: "watch_remove",
        description: "Удалить наблюдение",
        scope: "owner",
        usage: "/watch_remove <id>",
    },
    {
        command: "watch_help",
        description: "Справка по настройке промпт-наблюдений",
        scope: "owner",
        usage: "/watch_help",
    },
    {
...
export const BOT_CAPABILITIES: BotCapabilityDescription[] = [
    ...
    },
    {
        ...
        category: "Telegram",
        summary: "Позволяет объединять несколько Telegram-чатов в именованные группы, включать умное отслеживание важных сообщений и настраивать промпт-наблюдения: источник, целевой чат и пользовательский критерий срабатывания.",
        examples: [
            "Создай группу Рабочие чаты из этих Telegram-чатов",
            "Проанализируй Рабочие чаты",
            "Следи за чатом руководителей и пиши в мой личный чат, если возникают проблемы",
        ],
        commands: ["/chatgroups", "/chats", "/watch"],
        ownerOnly: true,
    },
    {
        id: "web-search",
