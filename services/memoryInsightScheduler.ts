...
- ВАЖНО: различай статус события: если событие ещё ПРЕДСТОИТ — давай подготовительные советы; если событие УЖЕ ПРОИСХОДИТ (дата начала = сегодня или в прошлом, окончание ещё не наступило) — пользователь уже в этом состоянии, не давай советы "не забудь" / "подготовься". Генерируй сообщение соответствующее ТЕКУЩЕМУ состоянию
