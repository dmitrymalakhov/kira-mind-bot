...
5. Если пользователь ИСПРАВЛЯЕТ неверное предположение бота — это важный факт, сохрани его с датой
...
✅ Бот: "ты сегодня во Вьетнам улетаешь", Пользователь: "Я уже во Вьетнаме" → Факт: "Сейчас во Вьетнаме (с ${today})" (domain: travel, importance: 0.85)
✅ Бот: "ты скоро летишь на конференцию", Пользователь: "я уже там" → Факт: "Сейчас на конференции (с ${today})" (domain: travel, importance: 0.8)
✅ Пользователь: "Вернулся из Вьетнама" → Факт: "Вернулся из Вьетнама (${today})" (domain: travel, importance: 0.75)
