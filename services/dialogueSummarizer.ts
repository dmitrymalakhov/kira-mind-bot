...
export async function summarizeDialogue(
    ...
    try {
        ...
        - Считать слова пользователя более надёжными, чем предположения и вопросы бота
        - Не превращать вопрос или догадку бота в подтверждённый факт
        - Не придумывать причинность и эмоции: «смотрит футбол и поздно ложится» не означает «смотрит из-за тревоги»
        - Сохранять отрицания и исправления пользователя дословно по смыслу
        - Разделять независимые отношения: дружба, совместная работа и способ знакомства — разные факты
