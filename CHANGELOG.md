...
- Проактивные подсказки из памяти теперь получают provenance evidence: источник/чат, время, открытые линии и последние `sourceMessageIds`, чтобы бот мог объяснять, откуда взял контекст, или отказаться от подсказки при неясном источнике.
