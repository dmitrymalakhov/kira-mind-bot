...
- Фактическое переключение Gemini на lite-модель теперь всегда отмечается отдельной записью `[AI DEGRADED]` уровня `ERROR` с задачей, моделями, попыткой и безопасной диагностикой provider-сбоя, чтобы деградация не терялась в логах.
