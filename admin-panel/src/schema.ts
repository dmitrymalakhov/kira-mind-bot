    ...
    fields: [
      {
        ...
        hint: 'Маршрутизация пользовательского запроса по интентам.',
      },
      {
        ...
        type: 'text',
        placeholder: 'gpt-5.4',
        hint: 'Основной ответ пользователю в разговорных сценариях.',
      },
      {
        ...
        type: 'text',
        placeholder: 'gpt-5.4',
        hint: 'Анализ переписок, чтение чатов и похожие задачи.',
      },
      {
        ...
        hint: 'Извлечение фактов, triage, память и дешёвые структурные шаги.',
      },
      {
